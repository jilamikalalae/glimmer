...
const womenProducts = [
  { id: 1, name: "Balloon Skirt", price: "$30/week", color: "Cream", season: "Spring", sizes: ["S", "M", "L"], img: "/image_woman/balloon skirt.jpg" },
  { id: 2, name: "Black Cardigan", price: "$50/week", color: "Black", season: "Winter", sizes: ["M", "L"], img: "/image_woman/black cardigan.jpg" },
  { id: 3, name: "Black Leather Jacket", price: "$50/week", color: "Black", season: "Fall", sizes: ["S", "M"], img: "/image_woman/black jacket.jpg" },
  { id: 4, name: "Formal Brown Blazer", price: "$50/week", color: "Brown", season: "Winter", sizes: ["M", "L", "XL"], img: "/image_woman/brown blazer.jpg" },
  { id: 5, name: "Off Shoulder Flounce", price: "$50/week", color: "White", season: "Summer", sizes: ["S", "M"], img: "/image_woman/Off Shoulder Flounce .jpg" },
  { id: 6, name: "Classy Ivory Strip Sweater", price: "$50/week", color: "Ivory", season: "Winter", sizes: ["M", "L"], img: "/image_woman/sweater.jpg" },
];
